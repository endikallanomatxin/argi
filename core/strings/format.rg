...
format_unsigned_decimal_into_u64(
    ...
    match reversed_result {
        ...
        ..ok ~ payload {
            ...
            while current > 0 {
                digit ::= current % 10
                pushed ::= push_byte_growing(.self = $&reversed, .byte = decimal_digit_byte(.digit = digit).byte, .allocator = allocator)
                match pushed {
                    ..ok _ {
                    }
                    ..error _ {
...
format_into(
    ...
    result = format_unsigned_decimal_into_u64(.out = out, .value = cast#(.to: UInt64)(.value = value), .allocator = allocator)
}
...
format_into(
    ...
    result = format_signed_decimal_into_i64(.out = out, .value = cast#(.to: Int64)(.value = value), .allocator = allocator)
}
...
format(
    ...
    result = format(.value = cast#(.to: UInt64)(.value = value), .allocator = allocator)
}
...
format(
    ...
    result = format(.value = cast#(.to: Int64)(.value = value), .allocator = allocator)
}
