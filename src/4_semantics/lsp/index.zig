...
pub fn targetsEqual(a: Target, b: Target) bool {
    return switch (a) {
        .function => |value| switch (b) {
            .function => |other| value == other,
            else => false,
        },
        .binding => |value| switch (b) {
            .binding => |other| value == other,
            else => false,
        },
        .declaration => |value| switch (b) {
            .declaration => |other| value == other,
            else => false,
        },
        .field => |value| switch (b) {
            .field => |other| value == other,
            else => false,
        },
        .variant => |value| switch (b) {
            .variant => |other| value == other,
            else => false,
        },
    };
}
