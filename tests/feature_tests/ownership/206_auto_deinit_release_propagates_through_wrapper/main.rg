...
deinit(.self: $&Domain) -> () := {
    trusted_opaque_release_all(.storage = self&.storage)
}
        ...
        ..ok ~ target_payload {
            ...
            match storage_result {
                ...
                ..ok ~ storage_payload {
                    ...
                    trusted_opaque_store_owned_in#(.t: Borrowing, .storage_type: Container)(.storage = $&container, .destination = slot, .source = ~value)
